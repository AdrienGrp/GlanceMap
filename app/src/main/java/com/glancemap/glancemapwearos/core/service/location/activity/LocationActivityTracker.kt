...
internal class LocationActivityTracker(
    ...
    fun onAcceptedLocation(location: Location, nowElapsedMs: Long): LocationActivityTransition? {
        ...
        val enterDisplacement = displacementWithinWindowMeters(
        ...
        val exitDisplacement = displacementWithinWindowMeters(
            nowElapsedMs = nowElapsedMs,
            currentLocation = location,
        ...
        val newState = classifier.evaluate(
            nowElapsedMs = nowElapsedMs,
            speedMps = speed,
    ...
    private fun updateMovementHistory(location: Location, nowElapsedMs: Long) {
    ...
    private fun hasHistoryForWindow(nowElapsedMs: Long, windowMs: Long): Boolean {
    ...
    private fun displacementWithinWindowMeters(
        ...
        val reference = movementHistory.firstOrNull { nowElapsedMs - it.elapsedMs <= windowMs }
