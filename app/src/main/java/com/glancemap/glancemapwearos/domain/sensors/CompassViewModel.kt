...
class CompassViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val northReferenceStatus = renderState
    ...
    val magneticInterference = renderState
