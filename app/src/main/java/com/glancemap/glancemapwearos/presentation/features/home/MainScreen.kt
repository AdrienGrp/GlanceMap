...
fun MainScreen(
    ...
    val baseButtonWidth = when (screenSize) {
    ...
    val settingsButtonBottomPadding = when (screenSize) {
    ...
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        val centerButtonWidth = if (adaptive.isRound) {
            if (compactScreen) {
        ...
        val centerColumnOffset = if (adaptive.isRound && compactScreen) {
