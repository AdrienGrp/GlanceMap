...
- Theme name: `French Kiss`
- Current bundled snapshot:
  - `app/src/main/assets/theme/frenchkiss/frenchkiss.xml`
  - `app/src/main/assets/theme/frenchkiss/motifs/`
- Source used for this local bundle:
  - User-provided `xctrack-beta-latest.apk`

## Observed provenance

The embedded XML header identifies the theme as:

- `IGN TOP25 theme for XCTrack by Pascal Cochet`

The extracted APK snapshot contained:

- `frenchkiss.xml`
- `motifs/` PNG resource directory

No standalone license/readme file was observed next to these assets in the APK snapshot used for extraction.
